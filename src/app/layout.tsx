...
export const metadata: Metadata = {
  title: "DuckBar - Authentic Ukrainian Bar & Local Community Gathering",
  description: "Experience authentic Ukrainian traditions at DuckBar. Traditional cuisine, local beers, and warm hospitality in a cozy neighborhood bar.",
  keywords: "Ukrainian bar, local pub, traditional cuisine, community gathering, craft beer",
  metadataBase: new URL("https://duckbar.local"),
  robots: {
    index: true,
    follow: true,
  },
  openGraph: {
    title: "DuckBar - Authentic Ukrainian Bar Experience",
    description: "Discover authentic Ukrainian traditions, local beers, and community warmth at DuckBar.",
    type: "website",
    siteName: "DuckBar",
    images: [
      {
        url: "https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_32SgGlSmvaVv2SYOkECykbr8Q49/uploaded-1764144326922-s8tfzzt0.jpg",
        alt: "DuckBar Ukrainian Bar"
      }
    ],
  },
  twitter: {
    card: "summary_large_image",
    title: "DuckBar - Local Ukrainian Bar",
    description: "Authentic traditions and community gathering place",
    images: ["https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_32SgGlSmvaVv2SYOkECykbr8Q49/uploaded-1764144326922-s8tfzzt0.jpg"],
  },
};
